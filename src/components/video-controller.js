...
/**
 * Base class for common video controller to manage an HTML5 video via the client-side ad insertion IMA SDK.
 * See the subclasses to for the "simpler" vs "video js" versions of the controllers.
 */
